...
lyr_OpenStreetMap_0.setVisible(true);lyr_RestaurantTrendsData_1.setVisible(true);lyr_IdentifiedSites_2.setVisible(true);lyr_TargetTradeAreas_3.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_RestaurantTrendsData_1,lyr_IdentifiedSites_2,lyr_TargetTradeAreas_3];
...
lyr_TargetTradeAreas_3.set('fieldAliases', {'id': 'id', 'temp_id': 'temp_id', 'new_area': 'new_area', 'geo_id': 'geo_id', 'lat': 'lat', 'lon': 'lon', 'layer': 'layer', 'path': 'path', 'type': 'type', 'selected': 'selected', 'seed_id': 'seed_id', 'optimizati': 'optimizati', 'addres': 'addres', 'city': 'city', 'state': 'state', 'cbsa_class': 'cbsa_class', 'density_cl': 'density_cl', 'comment': 'comment', });
...
lyr_TargetTradeAreas_3.set('fieldImages', {'id': 'TextEdit', 'temp_id': 'TextEdit', 'new_area': 'TextEdit', 'geo_id': 'TextEdit', 'lat': 'TextEdit', 'lon': 'TextEdit', 'layer': 'TextEdit', 'path': 'TextEdit', 'type': 'TextEdit', 'selected': 'TextEdit', 'seed_id': 'TextEdit', 'optimizati': 'TextEdit', 'addres': 'TextEdit', 'city': 'TextEdit', 'state': 'TextEdit', 'cbsa_class': 'TextEdit', 'density_cl': 'TextEdit', 'comment': 'TextEdit', });
